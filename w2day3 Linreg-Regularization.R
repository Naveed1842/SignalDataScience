setwd('/Users/svenchilton/GitHub/signal-data-science/R-curriculum/assignments/2-basic-topics/linear-regression/4-regularization/')
library('ggplot2')
library('dplyr')
library('Rmisc')
library('glmnet')
...
df = read.csv('/Users/svenchilton/GitHub/signal-data-science/R-curriculum/datasets/speed-dating-simple/speed-dating-simple.csv')
View(df)
...
cubist_grid = data.frame(committees=seq(30, 50, 5), neighbors=5:9)
?strsplit
